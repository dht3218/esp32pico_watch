...
const char* ei_classifier_inferencing_categories[] = { "calendar", "clock", "light", "noice", "setting" };
...
const uint32_t ei_learning_block_20_inputs[1] = { 21 };
const uint8_t ei_learning_block_20_inputs_size = 1;
...
const ei_performance_calibration_config_t ei_posprocessing_config_20 = {
    1, /* integer version number */
    true, /* has configured performance calibration */
    751, /* average duration window ms */
    0.3374564481420588, /* detection threshold */
    786,  /* suppression ms */
    0x17, /* suppression flags */
};
...
const ei_postprocessing_block_t ei_postprocessing_blocks[ei_postprocessing_blocks_size] = {
    {
        ...
        .config = (void*)&ei_posprocessing_config_20
    },
};
...
const ei_impulse_t impulse_563520_0 = {
    .project_id = 563520,
    .project_owner = "ht deng",
    .project_name = "pico_detect",
    .impulse_id = 1,
    .impulse_name = "Impulse #1",
    .deploy_version = 21,

    .nn_input_frame_size = 429,
...
ei_impulse_handle_t impulse_handle_563520_0 = ei_impulse_handle_t( &impulse_563520_0 );
ei_impulse_handle_t& ei_default_impulse = impulse_handle_563520_0;
